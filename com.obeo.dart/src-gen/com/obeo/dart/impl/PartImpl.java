 ...
 * </p>
 * <ul>
 *   <li>{@link com.obeo.dart.impl.PartImpl#getPartOf <em>Part Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PartImpl extends DartResourceImpl implements Part {
		...
		if (partOf != null && partOf.eIsProxy()) {
			...
			if (partOf != oldPartOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.PART__PART_OF, oldPartOf,
							partOf));
			}
		}
		return partOf;
	...
	public NotificationChain basicSetPartOf(Library newPartOf, NotificationChain msgs) {
		...
		partOf = newPartOf;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DartPackage.PART__PART_OF,
					oldPartOf, newPartOf);
			if (msgs == null)
				msgs = notification;
			else

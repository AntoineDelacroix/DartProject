 ...
 * </p>
 * <ul>
 *   <li>{@link com.obeo.dart.impl.RouteImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.obeo.dart.impl.RouteImpl#getPath <em>Path</em>}</li>
 *   <li>{@link com.obeo.dart.impl.RouteImpl#getView <em>View</em>}</li>
 *   <li>{@link com.obeo.dart.impl.RouteImpl#getExtends <em>Extends</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public Route getExtends() {
		if (extends_ != null && extends_.eIsProxy()) {
			...
			if (extends_ != oldExtends) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.ROUTE__EXTENDS, oldExtends,
							extends_));
			}
		}
		return extends_;

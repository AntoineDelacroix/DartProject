 ...
 * </p>
 * <ul>
 *   <li>{@link com.obeo.dart.impl.ExportImpl#getDartResource <em>Dart Resource</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ExportImpl#getShow <em>Show</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ExportImpl#getHide <em>Hide</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ExportImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportImpl extends MinimalEObjectImpl.Container implements Export {
		...
		if (dartResource != null && dartResource.eIsProxy()) {
			...
			if (dartResource != oldDartResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.EXPORT__DART_RESOURCE,
	...
	public void setDartResource(DartResource newDartResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.EXPORT__DART_RESOURCE, oldDartResource,
					dartResource));
	}

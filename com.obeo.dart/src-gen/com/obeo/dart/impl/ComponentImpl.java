 ...
 * </p>
 * <ul>
 *   <li>{@link com.obeo.dart.impl.ComponentImpl#getPublishAs <em>Publish As</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ComponentImpl#getStylesheet <em>Stylesheet</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ComponentImpl#getTemplate <em>Template</em>}</li>
 *   <li>{@link com.obeo.dart.impl.ComponentImpl#getSelector <em>Selector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ClassImpl implements Component {
	...
	public void setPublishAs(String newPublishAs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.COMPONENT__PUBLISH_AS, oldPublishAs,
					publishAs));
	}
	...
	public Stylesheet getStylesheet() {
		if (stylesheet != null && stylesheet.eIsProxy()) {
			...
			if (stylesheet != oldStylesheet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.COMPONENT__STYLESHEET,
	...
	public void setStylesheet(Stylesheet newStylesheet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.COMPONENT__STYLESHEET, oldStylesheet,
					stylesheet));
	}
	...
	public HTML getTemplate() {
		if (template != null && template.eIsProxy()) {
			...
			if (template != oldTemplate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.COMPONENT__TEMPLATE,
	...
	public void setTemplate(HTML newTemplate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.COMPONENT__TEMPLATE, oldTemplate,
					template));
	}
	...
	public void setSelector(String newSelector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.COMPONENT__SELECTOR, oldSelector,
					selector));
	}

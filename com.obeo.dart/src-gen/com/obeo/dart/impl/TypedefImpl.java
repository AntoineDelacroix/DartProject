 ...
 * </p>
 * <ul>
 *   <li>{@link com.obeo.dart.impl.TypedefImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link com.obeo.dart.impl.TypedefImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.obeo.dart.impl.TypedefImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.obeo.dart.impl.TypedefImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link com.obeo.dart.impl.TypedefImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypedefImpl extends MinimalEObjectImpl.Container implements Typedef {
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DartPackage.TYPEDEF__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.TYPEDEF__TYPE, oldType,
							type));
			}
		}
		return type;

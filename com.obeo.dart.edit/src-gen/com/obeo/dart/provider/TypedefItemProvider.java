...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Typedef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypedefItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Typedef_documentation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Typedef_documentation_feature",
								"_UI_Typedef_type"),
						DartPackage.Literals.TYPEDEF__DOCUMENTATION, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Typedef_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Typedef_name_feature", "_UI_Typedef_type"),
						DartPackage.Literals.TYPEDEF__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Typedef_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Typedef_type_feature", "_UI_Typedef_type"),
						DartPackage.Literals.TYPEDEF__TYPE, true, false, true, null, null, null));
	}
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Typedef_metadata_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Typedef_metadata_feature",
								"_UI_Typedef_type"),
						DartPackage.Literals.TYPEDEF__METADATA, true, false, true, null, null, null));
	}

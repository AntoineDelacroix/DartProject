...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider extends ContainerItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DartPackage.Literals.PACKAGE__NAME, true, false, false,
	...
	protected void addLicensePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Package_license_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Package_license_feature",
								"_UI_Package_type"),
						DartPackage.Literals.PACKAGE__LICENSE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDependenciesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Package_dependencies_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Package_dependencies_feature",
								"_UI_Package_type"),
						DartPackage.Literals.PACKAGE__DEPENDENCIES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((com.obeo.dart.Package) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.obeo.dart.Package.class)) {

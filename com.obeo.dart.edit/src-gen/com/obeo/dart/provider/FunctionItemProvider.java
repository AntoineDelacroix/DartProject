...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Function_name_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__NAME, true, false, false,
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_documentation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_documentation_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__DOCUMENTATION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_type_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__TYPE, true, false, true, null, null, null));
	}
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_abstract_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_abstract_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__ABSTRACT, true, false, false,
	...
	protected void addStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_static_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_static_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__STATIC, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_body_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_body_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__BODY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Function_metadata_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Function_metadata_feature",
								"_UI_Function_type"),
						DartPackage.Literals.FUNCTION__METADATA, true, false, true, null, null, null));
	}

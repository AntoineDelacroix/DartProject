...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider extends ClassifierItemProvider {
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DartPackage.Literals.CLASS__ABSTRACT, true, false, false,
	...
	protected void addExtendsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_extends_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Class_extends_feature", "_UI_Class_type"),
						DartPackage.Literals.CLASS__EXTENDS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Class_implements_feature",
								"_UI_Class_type"),
						DartPackage.Literals.CLASS__IMPLEMENTS, true, false, true, null, null, null));
	}
	...
	protected void addMixinsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_mixins_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Class_mixins_feature", "_UI_Class_type"),
						DartPackage.Literals.CLASS__MIXINS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((com.obeo.dart.Class) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.obeo.dart.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(DartPackage.Literals.CLASS__METHODS, DartFactory.eINSTANCE.createFunction()));
	}

...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.HTML} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HTMLItemProvider extends AssetItemProvider {
	...
	protected void addUsesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_HTML_uses_feature"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_HTML_type")
				: getString("_UI_HTML_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Classifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifierItemProvider extends PartItemProvider {
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Classifier_metadata_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Classifier_metadata_feature",
								"_UI_Classifier_type"),
						DartPackage.Literals.CLASSIFIER__METADATA, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DartPackage.Literals.CLASSIFIER__FIELDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(DartPackage.Literals.CLASSIFIER__FIELDS, DartFactory.eINSTANCE.createVariable()));
	}

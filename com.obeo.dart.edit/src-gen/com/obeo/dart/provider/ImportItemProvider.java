...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDartResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_dartResource_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_dartResource_feature",
								"_UI_Import_type"),
						DartPackage.Literals.IMPORT__DART_RESOURCE, true, false, true, null, null, null));
	}
	...
	protected void addAsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_as_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_as_feature", "_UI_Import_type"),
						DartPackage.Literals.IMPORT__AS, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addShowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_show_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_show_feature", "_UI_Import_type"),
						DartPackage.Literals.IMPORT__SHOW, true, false, true, null, null, null));
	}
	...
	protected void addHidePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_hide_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_hide_feature", "_UI_Import_type"),
						DartPackage.Literals.IMPORT__HIDE, true, false, true, null, null, null));
	}
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Import_metadata_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Import_metadata_feature",
								"_UI_Import_type"),
						DartPackage.Literals.IMPORT__METADATA, true, false, true, null, null, null));
	}

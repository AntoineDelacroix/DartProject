...
/**
 * This is the item provider adapter for a {@link com.obeo.dart.Constructor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstructorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addConstantPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Constructor_constant_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Constructor_constant_feature",
								"_UI_Constructor_type"),
						DartPackage.Literals.CONSTRUCTOR__CONSTANT, true, false, false,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Constructor_body_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Constructor_body_feature",
								"_UI_Constructor_type"),
						DartPackage.Literals.CONSTRUCTOR__BODY, true, false, false,
	...
	protected void addMetadataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Constructor_metadata_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Constructor_metadata_feature",
								"_UI_Constructor_type"),
						DartPackage.Literals.CONSTRUCTOR__METADATA, true, false, true, null, null, null));
	}
